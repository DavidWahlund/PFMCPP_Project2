...
1)
*/
int addNumbers(int number1 = 5, int number2 = 10) {
...
2)
*/
int subtractNumbers(int number1 = 20, int number2 = 15) {
  ignoreUnused(number1, number2);
  return {};
};
...
3)
*/
int moveCharacter(int left = 3, int right = 7) {
...
/*
 5)
 */
void playSound(int sound1 = 1, int sound2 = 2, int sound3 = 3) {
...
/*
 6)
 */
void streamVideo(int video1 = 1, int video2 = 2, int video3 = 3) {
...
/*
 7)
 */
bool randomValue(int valueOne = 1, int valueTwo = 2, int valueThree = 3) {
...
int main() {
  ...
  // 1)
  auto addedNumbers = addNumbers(5, 10);

  // 2)
  auto subtractedNumbers = subtractNumbers(20, 15);

  // 3)
  auto movedCharacter1 = moveCharacter(3, 7);

  // 4)
  auto movedCharacter2 = moveCharacter(2, 8);
  ...
  // 7)
  auto randomizedValues = randomValue(1, 2, 3);
  ...
  ignoreUnused(carRented, addedNumbers, subtractedNumbers, movedCharacter1,
               movedCharacter2, randomizedValues, stringNamed, largeValues,
               isTruish);
